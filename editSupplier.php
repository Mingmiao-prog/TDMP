...
<head>
    ...
    <title>Leong Lee | Edit Supplier Details</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="supplierList.php">Supplier Depository</a>
                        </li>
                        <li class="active">
                            <strong>Edit Supplier Details</strong>
                        </li>
                    </ol>
                </div>
                <!--<div class="col-lg-4">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <?php
                                    $dao = new SupplierDAO();
                                    $thesupplier = $dao->retrieve($_GET['id']); ?>
                                <form id="bidForm" action="editSupplierProcess.php" method="post">
                                    <div class="form-group">
                                        <label for="sectionNo">Supplier ID</label>
                                        <input type="text" class="form-control" name='supplier_id' value="<?php echo $thesupplier->getId();?>" required readonly>
                                        <label for="sectionNo">Supplier Name</label>
                                        <input type="text" class="form-control" name='supplier_name' value="<?php echo $thesupplier->getSupplierName();?>" required>
                                    </div>
                                    <button type="submit" class="btn btn-primary" name="SubmitSupplier">Submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
