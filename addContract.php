...
<head>
    ...
    <title>Leong Lee | Add New Contract</title>
    <?php
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Add New Contract</strong>
                        </li>
                    </ol>
                </div>
                <!--<div class="col-lg-4">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Add New Contract Details</h5>
                            </div>
                            <div class="ibox-content">
                                ...
                                ?>
                                <form id="bidForm" action="addContractProcess.php" method="post">
                                    <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="supplier_name" id="suppliers">
                                            ...
                                            ?>
                                                <option value="<?php echo $eachsupplier->getId(); ?>"><?php echo $eachsupplier->getSupplierName();
                                                                                                    } ?></option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="powerplant_name" id="powerplants">
                                            ...
                                            ?>
                                                <option value="<?php echo $eachpowerplant->getId(); ?>"><?php echo $eachpowerplant->getPowerplantName();
                                                                                                    } ?></option>
                                        </select>
                                    </div>
                                    <div class="form-group">
