...
<head>
    ...
    <title>Leong Lee | Edit Mother Vessel Details</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    <h2>Edit Mother Vessel Details</h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <strong>Edit Mother Vessel Details</strong>
                        </li>
                    </ol>
                </div>
                <!--<div class="col-lg-4">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Edit Mother Vessel Details </h5>
                            </div>
                            <div class="ibox-content">
                                ...
                                $mothervessel = $dao->retrieve($id);
								
								$uid = $mothervessel->getMVMSSI();
								$uname = $mothervessel->getMVname();
								$uLOA = $mothervessel->getMVLOA();
								$ucap = $mothervessel->getMVcap();
								
								?>
                                <form id="editMVForm" action="updateMotherVesselProcess.php" method="post">
                                    <div class="form-group">
                                        <label for="update_mssi">MV MSSI</label>
                                        <input type="text" class="form-control" name='update_mssi' value=<?php echo $uid?> readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="update_name">MV Name</label>
                                        <input type="text" class="form-control" name='update_name' value="<?php echo $uname?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="update_LOA">MV LOA (m)</label>
                                        <input type="text" class="form-control" name='update_LOA' value=<?php echo $uLOA?> required>
                                    </div>
									<div class="form-group">
                                        <label for="update_cap">MV Capacity/DWT (ton)</label>
										<input type="text" class="form-control" name='update_capacity' value=<?php echo $ucap?> required>
                                    </div>
                                    <button type="submit" class="btn btn-primary" name="SubmitMV">Submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
