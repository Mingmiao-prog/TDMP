...
<head>
    ...
    <title>Leong Lee | Add New Powerplant</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Add New Powerplant</strong>
                        </li>
                    </ol>
                </div>
                <!--<div class="col-lg-4">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Add New Powerplant Details</h5>
                            </div>
                            <div class="ibox-content">
                                ...
                                ?>
                                <form id="bidForm" action="addPowerplantProcess.php" method="post">
                                    <!-- <div class="form-group">
                                        <label for="course_code">Supplier ID</label>
                                        <input type="text" class="form-control" name='supplier_id' placeholder="Supplier ID" required>
                                    </div> -->
                                    <div class="form-group">
                                        <label for="sectionNo">Powerplant Name</label>
                                        <input type="text" class="form-control" name='powerplant_name' placeholder="Powerplant Name" required>
                                    </div>
